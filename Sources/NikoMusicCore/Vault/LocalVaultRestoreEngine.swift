...
public actor LocalVaultRestoreEngine {
        ...
        do {
            ...
            while record.completedAt == nil {
                ...
                case .materializingArchive:
                    ...
                    try manifestBuilder.verify(manifest, at: record.archiveGenerationURL)
    ...
    private func copyToStaging(
        ...
        try await writeAdmission(VaultWriteAdmissionRequest(
            ...
            do {
                try manifestBuilder.verify(manifest, at: sourceURL)
    ...
    private static func copyManifestEntries(
    ...
    private static func manifestEntryURLs(
        ...
        return (
            sourceRoot.appendingPathComponent(relativePath).standardizedFileURL,
            destinationRoot.appendingPathComponent(relativePath).standardizedFileURL
        )
    }
