...
enum ArchiveSmokeCommands {
    ...
    private static func runUserFlowSmoke(fixtureRoot: URL) throws {
        ...
        guard result.searchQuery == "neon hk",
              ...
              result.previewSearchMatchTitle == "Lab Song",
              ...
              result.previewSearchPanelMatchLines.contains("Lab Song"),
              ...
              result.diagnosticsExportSummaryLine.contains("Scanned 9 songs"),
              !result.diagnosticsPanelSupportSummary.isEmpty,
              result.diagnosticsPanelSupportSummary.hasPrefix("roots:"),
              result.diagnosticsPanelSupportSummary.contains("Scanned 9 songs"),
              ...
              result.fixtureScanCountsPanelSongsValue == "9",
