...
| `NIKO_MUSIC_HUB_DEV_ARCHIVE_ROOT` | Explicit dev archive root for one launch when settings have no roots; it is not persisted and does not complete onboarding |
