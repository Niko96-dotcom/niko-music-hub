...
| 122 | Test Restore / Keep Local / fail-closed OK; **Friends+backup removal still product-gated** (documented, not a regression) |
...
| 117 | Candidate pagination pageSize=24 + Compare/Ignore |
...
Focused `swift test` batches: 0 failures.
