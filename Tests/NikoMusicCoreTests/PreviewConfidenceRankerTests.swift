...
final class PreviewConfidenceRankerTests: XCTestCase {
    ...
    func testCPRAnchorDemotesDemoV06BelowCubaseStyleV4MP3() {
        ...
        let cubaseMix = candidate(
            name: "GLÜHWURM - 90s HEART V4 (Glühwurm, Writer One, Writer Two).mp3",
            role: .unknown,
            modifiedAt: baseDate,
            version: 4,
            ext: "mp3",
        ...
        XCTAssertEqual(
            ...
            "GLÜHWURM - 90s HEART V4 (Glühwurm, Writer One, Writer Two).mp3"
        )
    }
    ...
    func testCPRAnchorDemotesDemoV06BelowTitleMatchedV4Mix() {
        ...
        XCTAssertEqual(ranked.first?.fileName, "90s HEART v4 mix.wav")
