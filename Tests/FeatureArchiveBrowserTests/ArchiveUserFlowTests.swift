...
final class ArchiveUserFlowTests: XCTestCase {
    func testFixtureUserFlowScanSearchOpenDryRunLeavesArchiveUnchanged() async throws {
        ...
        XCTAssertTrue(result.diagnosticsExportSummaryLine.contains("Scanned 5 songs"))
        ...
        XCTAssertTrue(result.healthyExportOmitsRootHealthBadge)
        XCTAssertTrue(result.healthyPanelRootHealthBadgeNil)
        ...
        XCTAssertTrue(result.diagnosticsPanelSupportSummary.contains("Scanned 5 songs"))
        ...
        XCTAssertEqual(result.previewSearchQuery, "v3 mx")
        XCTAssertEqual(result.previewSearchMatchCount, 1)
        ...
        XCTAssertTrue(result.previewSearchMatchSummary.contains("mx"))
